...
1. Fork the repo
1. Make commits to your forked repo. Prefix each commit like so:
...
1. When you've finished with your fix or feature, push changes into your master branch. submit a [pull request][]
...
```
git remote add upstream https://github.com/StirTech/TeamUp.git
```

### Make commits to your forked repo. 
...
Make changes and commits on your master branch.
...
### Rebase upstream changes into your master branch
...
## Summary workflow
  ...
  ```
  $ git clone https://github.com/USERNAME/TeamUp.git
  ```
  ...
  in your commits :
    ...
    ```bash
      # Edit some code
      $ git commit -m "(feat) Add first draft of feature A"
    ```
  ...
  8. Create pull request to upstream repo (Organization repo)
